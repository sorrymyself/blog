...
python /root/snap2html/DiogenesList-master/diogeneslist.py /root/GD index
...
#sed -i "s#\\\\\\\root\\\\\\\GD##g"  /root/snap2html/DiogenesList-master/index.html
#sed -i "s#1>index#1>风花护发素#g" /root/snap2html/DiogenesList-master/index.html
